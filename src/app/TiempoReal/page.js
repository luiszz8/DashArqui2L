...
const Dashboard = () => {
  ...
  const [errorMessage, setErrorMessage] = useState(''); // Estado para mostrar un mensaje de error
  ...
  const handleParqueo = () => {
    if (password === 'admin') {
      ...
      Talanquera(); // Ejecuta la lógica del botón parqueo
    } else {
      setErrorMessage('Contraseña incorrecta'); // Muestra un mensaje de error
    }
  };
    ...
    <div>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          ...
          <div>
            <button
              onClick={handleParqueo}
              style={{
                backgroundColor: '#3b1ee0', // Color de fondo
                color: 'white', // Color del texto
                padding: '15px 32px', // Espaciado interno
                fontSize: '16px', // Tamaño de fuente
                border: '5px solid #000084', // Borde del botón con un tono más oscuro
                borderRadius: '12px', // Bordes redondeados
                cursor: 'pointer', // Cambia el cursor al pasar sobre el botón
                marginTop: '20px', // Margen superior
              }}
